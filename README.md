[index.html](https://github.com/user-attachments/files/26663630/index.html)[Upl<!DOCTYPE html>
...
<div id="login-screen">
  <div class="login-card">
    ...
    <div class="login-field"><label>اسم المستخدم</label><input type="text" id="login-user" value="" placeholder="أدخل اسم المستخدم"></div>
    <div class="login-field"><label>كلمة المرور</label><input type="password" id="login-pass" value="" placeholder="أدخل كلمة المرور"></div>
